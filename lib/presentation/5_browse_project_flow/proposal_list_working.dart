...
class _ProjectListState extends State<ProposalListWorking> {
              ...
              children: [
                ...
                SingleChildScrollView(
                  ...
                  child: Observer(builder: (context) {
                    final workingProposal = _projectStore.submitProposals
                        ?.where((proposal) =>
                            proposal.statusFlag == ProposalType.HIRED.value &&
                            proposal.project.typeFlag ==
                                ProjectType.WORKING.value)
                        .toList();
                    return workingProposal != null &&
                            workingProposal!.length > 0
                        ? Column(
